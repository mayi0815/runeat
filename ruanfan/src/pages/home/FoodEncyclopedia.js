    ...
    >
      ...
      <View style={{ alignItems: "center" }}>
        ...
        >
          ...
          />
          <Text style={{ color: "rgba(222, 113, 56, 0.8)", fontSize: 15 }}>
            请输入餐厅名称
          </Text>
        </TouchableOpacity>
      </View>
...
const FoodCategoryView = ({ foodCategory, onPress }) => {
  ...
  return (
    <View
      style={{ backgroundColor: "white", marginTop: 10, overflow: "hidden" }}
    >
      <View style={styles.groupHeader}>
        ...
        >
          <Image
            style={{ width: gScreen.width - 16 * 2, height: 14 }}
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    paddingTop: Platform.select({ ios: 35, android: 15 }),
    paddingBottom: 28,
